...
public:
    ...
    virtual DtContextHandle DiGetContext()  { dzApp->log("ReadyKitRenderer: unimplemented method: DiGetContext()"); return NULL; }
    ...
    virtual DtToken DiDeclare( const char *name, const char *declaration )  { dzApp->log("ReadyKitRenderer: unimplemented method: DiDeclare( const char *name, const char *declaration )"); return NULL; }
    ...
    // ------------------ Shaders
    virtual DtLightHandle   DiAreaLightSourceV( DtToken name, DtInt n, const DtToken tokens[], DtPointer params[] ) { dzApp->log("ReadyKitRenderer: unimplemented method: DiAreaLightSourceV( DtToken name, DtInt n, const DtToken tokens[], DtPointer params[] )"); return NULL; }
    ...
    virtual DtLightHandle   DiLightSourceV( DtToken name, DtInt n, const DtToken tokens[], DtPointer params[] ) { dzApp->log("ReadyKitRenderer: unimplemented method: DiLightSourceV( DtToken name, DtInt n, const DtToken tokens[], DtPointer params[] )"); return NULL; }
    ...
    virtual DtPoint*    DiTransformPoints( DtToken fromspace, DtToken tospace, DtInt npoints, DtPoint *points ) { dzApp->log("ReadyKitRenderer: unimplemented method: DiTransformPoints( DtToken fromspace, DtToken tospace, DtInt npoints, DtPoint *points )"); return NULL;}
    ...
    // ------------------ Object Instancing
    virtual DtObjectHandle  DiObjectBegin() { dzApp->log("ReadyKitRenderer: unimplemented method: DiObjectBegin()"); return NULL;}
    virtual DtObjectHandle  DiObjectBeginV( DtInt n, const DtToken tokens[], DtPointer params[] )   { dzApp->log("ReadyKitRenderer: unimplemented method: DiObjectBeginV( DtInt n, const DtToken tokens[], DtPointer params[] )"); return NULL;}
    ...
    virtual DtArchiveHandle DiArchiveBeginV( DtToken archivename, DtInt n, const DtToken tokens[], DtPointer params[] ) { dzApp->log("ReadyKitRenderer: unimplemented method: DiArchiveBeginV( DtToken archivename, DtInt n, const DtToken tokens[], DtPointer params[] )"); return NULL;}
    ...
    virtual int DSlo_SetPath( const char *i_path )    { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_SetPath( const char *i_path )"); return -1;}
    virtual int DSlo_SetShader( const char *i_name )  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_SetShader( const char *i_name )"); return -1;}
    virtual const char* DSlo_GetName()  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetName()"); return NULL;}
    virtual DSLO_TYPE   DSlo_GetType()  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetType()"); return DSLO_TYPE_UNKNOWN;}
    virtual int DSlo_HasMethod( const char *i_name )  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_HasMethod( const char *i_name )"); return -1;}
    virtual const char* const*	DSlo_GetMethodNames(){ dzApp->log("ReadyKitRenderer: unimplemented DSlo call"); return NULL;};
    virtual int DSlo_GetNArgs() { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetNArgs()"); return 0;}

    virtual DSLO_VISSYMDEF* DSlo_GetArgById( int i_id ) { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetArgById( int i_id )"); return NULL;}
    virtual DSLO_VISSYMDEF* DSlo_GetArgByName( const char *i_name ) { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetArgByName( const char *i_name )"); return NULL;}
    virtual DSLO_VISSYMDEF* DSlo_GetArrayArgElement( DSLO_VISSYMDEF *i_array, int i_index ) { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetArrayArgElement( DSLO_VISSYMDEF *i_array, int i_index )"); return NULL;}

    virtual int DSlo_GetNAnnotations()  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetNAnnotations()"); return 0;}
    virtual const char* DSlo_GetAnnotationKeyById( int i_id )   { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetAnnotationKeyById( int i_id )"); return NULL;}
    virtual const char* DSlo_GetAnnotationByKey( const char *i_key )    { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_GetAnnotationByKey( const char *i_key )"); return NULL;}

    virtual void    DSlo_EndShader()    { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_EndShader()"); }
    virtual const char* DSlo_TypetoStr( DSLO_TYPE i_type )  { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_TypetoStr( DSLO_TYPE i_type )"); return NULL;}
    virtual const char* DSlo_StortoStr( DSLO_STORAGE i_storage )    { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_StortoStr( DSLO_STORAGE i_storage )"); return NULL;}
    virtual const char* DSlo_DetailtoStr( DSLO_DETAIL i_detail )    { dzApp->log("ReadyKitRenderer: unimplemented method: DSlo_DetailtoStr( DSLO_DETAIL i_detail )"); return NULL;}
    ...
    virtual bool    bake( DzRenderHandler *handler, DzCamera *camera, DzLightListIterator &lights, DzNodeListIterator &nodes, const DzBakerOptions &opt )   { dzApp->log("ReadyKitRenderer: unimplemented method: bake( DzRenderHandler *handler, DzCamera *camera, DzLightListIterator &lights, DzNodeListIterator &nodes, const DzBakerOptions &opt )"); return false;}
    virtual bool    autoBake( DzRenderHandler *handler, DzCamera *camera, DzLightListIterator &lights, DzNodeListIterator &nodes, const DzBakerOptions &opt )   { dzApp->log("ReadyKitRenderer: unimplemented method: autoBake( DzRenderHandler *handler, DzCamera *camera, DzLightListIterator &lights, DzNodeListIterator &nodes, const DzBakerOptions &opt )"); return false;}
    ...
    virtual bool    textureConvert( DzRenderHandler *handler, DzCamera *camera, const DzTextureConvertorOptions &opt )  { dzApp->log("ReadyKitRenderer: unimplemented method: textureConvert( DzRenderHandler *handler, DzCamera *camera, const DzTextureConvertorOptions &opt )"); DzRenderer::textureConvert(handler, camera, opt); return false;}
    //
    // ACCESSORS
    //

    virtual QString getShaderCompilerPath() { dzApp->log("ReadyKitRenderer: unimplemented method: getShaderCompilerPath()"); return NULL;}
    virtual QString getTextureUtilityPath() { dzApp->log("ReadyKitRenderer: unimplemented method: getTextureUtilityPath()"); return NULL;}

    virtual QStringList getShaderSearchPaths() const { dzApp->log("ReadyKitRenderer: unimplemented method: getShaderSearchPaths()"); return QStringList("");}
    virtual QString processShaderName( const QString &shaderName ) const { dzApp->log("ReadyKitRenderer: unimplemented method: processShaderName( const QString &shaderName )"); return NULL;}
    virtual QString getShaderPath( const QString &shaderName, bool withExtension = true ) const { dzApp->log("ReadyKitRenderer: unimplemented method: getShaderPath( const QString &shaderName, bool withExtension = true )"); return NULL;}
    virtual QString getShaderFileName( const QString &shaderName ) const    { dzApp->log("ReadyKitRenderer: unimplemented method: getShaderFileName( const QString &shaderName )"); return NULL;}
    virtual QString getShaderExtension() const  { dzApp->log("ReadyKitRenderer: unimplemented method: getShaderExtension()"); return NULL;}
    virtual bool    isRendering() const { dzApp->log("ReadyKitRenderer: unimplemented method: isRendering()"); return false;}
    virtual QString getName() const { dzApp->log("ReadyKitRenderer: unimplemented method: getName()"); return graphicsState->rendererName;}
    virtual DzNode* getCurrentNode() const  { dzApp->log("ReadyKitRenderer: unimplemented method: getCurrentNode()"); return NULL;}


public:

    virtual DzOptionsFrame* getOptionsFrame() const ;
    virtual DtFilterFunc    getFilterFunction( DzRenderOptions::PixelFilter filterType ) const  { dzApp->log("ReadyKitRenderer: unimplemented method: getFilterFunction( DzRenderOptions::PixelFilter filterType )"); return NULL;}
